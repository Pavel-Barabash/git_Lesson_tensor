...
if manual == 'да':
    ...
    dig_a = int(input('Какое максимальное значение укажем для первого набора?: '))
    print('')

    count_b = int(input('Сколько чисел будет во втором наборе: '))
    dig_b = int(input('Какое максимальное значение укажем для второго набора?: '))
    print('')
elif manual == 'нет':
    count_a = count_b = 10
    dig_a = dig_b = 20
else:
    print('Всего то необходимо ответить "да" или "нет", попробуй с самого начала как будешь готов.')
